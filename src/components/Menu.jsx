...
import { allCocktailsLists } from '../../constant';
...
const Menu = () => {
    ...
    const totalCocktails = allCocktailsLists.length;
    const goToSlide = (index) => {
        const newIndex = (index + totalCocktails) % totalCocktails;
        setCurrentIndex(newIndex);
    };
    const getCocktailAt = (indexOffset) => {
        return allCocktailsLists[(currentIndex + indexOffset + totalCocktails) % totalCocktails];
    };
